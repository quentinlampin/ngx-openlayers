...
@Component({
  ...
  template: `
    <aol-map (pointerMove)="displayInfo($event.coordinate)">
      ...
      <aol-layer-tile> <aol-source-tilejson [url]="'https://api.tiles.mapbox.com/v4/mapbox.geography-class.json?secure&access_token=' + key"></aol-source-tilejson></aol-layer-tile>
      <aol-layer-tile>
        <aol-source-utfgrid
          #UTFGrid
